 ...
 *
 */
public class AddAttributeDialog extends Dialog implements GUIDefaults {
	...
	public AddAttributeDialog(Shell parentShell, String dialogTitle, String dialogMessage, String initialValue) {
		super(parentShell);
		title = dialogTitle;
